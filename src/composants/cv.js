...
using .NET" line4= "-Used to develop, design, code, unit test, debug, integrate, document and actively participate in all software life cycle (AGILE)" line5= "-Managed source code and tickets with Git and TRAC and worked with Jenkins for Continuous Integration"/>
